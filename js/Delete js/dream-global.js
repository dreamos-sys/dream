...
(function() {
    ...
    window.DREAM = {
        ...
        modulePaths: {
            ...
            'security': './modules/sekuriti/module.js',  // Alias
            'qr': './modules/qr/module.js',
            'qr-scanner': './modules/qr/module.js',       // Alias
            'scanner': './modules/qr/module.js',          // Alias
            'settings': './modules/settings/module.js',
            'ghost': './modules/ghost/module.js',
            'developer': './modules/ghost/module.js'      // Alias
        },
        ...
        load: async function(moduleName, params) {
            ...
            try {                // Check cache first
                ...
                if (window.app && typeof window.app.loadModule === 'function') {
                    return window.app.loadModule(resolvedName, params, module);
                }
        ...
        setupKeyboardShortcuts: function() {
            document.addEventListener('keydown', (e) => {
                ...
                if (e.key === 'Escape' && window.app?.state?.currentModule) {
