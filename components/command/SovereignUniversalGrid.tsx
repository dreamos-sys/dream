  ...
  return (
    <div className="w-full min-h-screen bg-[#020617] text-white flex flex-col items-center justify-center p-4 md:p-10 font-sans">
      <header className="mb-10 text-center">
        ...
        <p className="text-[10px] text-white/30 tracking-[0.5em] mt-2 uppercase italic">Sovereign Edition • Neural Sync</p>
      </header>
        ...
        {modules.map((m, i) => {
          ...
          return (
            <motion.button
              ...
              whileTap={{ scale: 0.9 }}
              className="aspect-square flex flex-col items-center justify-center bg-white/5 rounded-[25px] md:rounded-[35px] border border-white/10 shadow-2xl group transition-all duration-300"
            >
              <Icon className="w-10 h-10 md:w-16 md:h-16 mb-3 text-[#FFD700] group-hover:drop-shadow-[0_0_10px_#FFD700]" />
